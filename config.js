...
global.timezone  = process.env.TIME_ZONE || 'Asia/Pakistan'
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;TastesHeader
",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'honey loru',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `It'x kiyani`,
